//
//  WXTabBarControllerConfig.m
//  WX
//
//  Created by Siri on 2018/8/27.
//  Copyright © 2018年 com.roadoor. All rights reserved.
//
...
@implementation WXTabBarControllerConfig
...
- (NSArray *)tabBarItemsAttributesForController {
    NSDictionary *firstTabBarItemsAttributes = @{
                                                 ...
                                                 CYLTabBarItemImage : @"tabbar_home_normal",  /* NSString and UIImage are supported*/
                                                 CYLTabBarItemSelectedImage : @"tabbar_home_select", /* NSString and UIImage are supported*/
                                                 };
    NSDictionary *secondTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"我的",
                                                  CYLTabBarItemImage : @"tabbar_usercenter_normal",
                                                  CYLTabBarItemSelectedImage : @"tabbar_usercenter_select"
                                                  };
...
#warning CUSTOMIZE YOUR TABBAR APPEARANCE
    ...
    normalAttrs[NSForegroundColorAttributeName] = tabbar_title_normal_color;
    
    // set the text color for selected state
    // 选中状态下的文字属性
    NSMutableDictionary *selectedAttrs = [NSMutableDictionary dictionary];
    selectedAttrs[NSForegroundColorAttributeName] = tabbar_title_select_color;
